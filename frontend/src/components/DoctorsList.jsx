...
export default function DoctorsList({ onSelectDoctor }) {
  ...
  const specialties = ["All Specialties", ...Object.keys(doctorsBySpecialty)];

  // Flatten doctors when "All Specialties" is chosen
  const displayedDoctors =
    selectedSpecialty === "All Specialties"
      ? Object.values(doctorsBySpecialty).flat()
      : doctorsBySpecialty[selectedSpecialty] || [];

  if (specialties.length === 1) { // only "All Specialties" but no doctors
    return (
      <div className="card">
        <div className="card-body">
